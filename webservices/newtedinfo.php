...
<table width="95%" border="0" cellpadding="5">
  ...
  <tr>
    <td colspan="2">
		...
		<p>
		<strong><font color="#225A8D" size="+1" face="Arial, Helvetica, sans-serif">Bug fixes</font></strong>
		</p>
		</p>
		<ul><li>For some users ted would not start anymore after upgrading to v0.97
		</li><li>Missing network icon added
		</li><li>Adjusted date string: "will air on today" is now "will air today"
		</li></ul>
		<p><br />
		 </font>
    </td>
